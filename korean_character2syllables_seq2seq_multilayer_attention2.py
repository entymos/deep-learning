...
## Model ##
batch_size = 256
total_epoch = 15000 #1500 #2000
learning_rate = 0.001 ## usually 0.0001, 0.001
n_hidden = 256 #256 ## =num_units
vocab_size = n_class = n_input = dic_len
num_layers = 10
dim_embedding = 15
encoder_length = 4 ## sequence_length
decoder_length = 4 ## sequence_length
dropout_factor = 0.5
...
print('넣 ->', translate_inference('넣'))
print('게 ->', translate_inference('게'))
print('종 ->', translate_inference('종'))
print('그 ->', translate_inference('그'))
print('장 ->', translate_inference('장'))
print('손 ->', translate_inference('손'))
print('안 ->', translate_inference('안'))
